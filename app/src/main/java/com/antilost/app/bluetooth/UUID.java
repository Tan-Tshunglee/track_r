...
public class UUID {
    ...
    public static final String KEY_PRESS_SERVICE_UUID = "0000ffe0-0000-1000-8000-00805f9b34fb";
    ...
    public static final String LINK_LOSS_SERICE_UUID = "00001803-0000-1000-8000-00805f9b34fb";
