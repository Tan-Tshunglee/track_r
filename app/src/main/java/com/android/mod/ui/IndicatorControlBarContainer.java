...
import com.android.mod.CameraPreference.OnPreferenceChangedListener;
import com.android.mod.PreferenceGroup;
...
public class IndicatorControlBarContainer extends IndicatorControlContainer {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (mIndicatorControlBar.getVisibility() == VISIBLE) {
            return mIndicatorControlBar.dispatchTouchEvent(event);
        } else if (mSecondLevelIndicatorControlBar.getVisibility() == VISIBLE) {
    ...
    private AnimationListener mAnimationListener = new AnimationListener() {
        public void onAnimationEnd(Animation animation) {
            if (animation == mSecondLevelFadeOut) {
                mSecondLevelIndicatorControlBar.setVisibility(GONE);
            } else if (animation == mFadeOut) {
                mIndicatorControlBar.setVisibility(GONE);
            }
        }
    ...
    public void dismissSecondLevelIndicator() {
        if (mSecondLevelIndicatorControlBar.getVisibility() == VISIBLE) {
            leaveSecondLevelIndicator();
        }
    }
}
