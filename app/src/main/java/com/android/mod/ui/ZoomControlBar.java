...
public class ZoomControlBar extends ZoomControl {
    ...
    private static final int THRESHOLD_FIRST_MOVE = com.android.mod.Util.dpToPixel(10); // pixels
    // Space between indicator icon and the zoom-in/out icon.
    private static final int ICON_SPACING = com.android.mod.Util.dpToPixel(12);
