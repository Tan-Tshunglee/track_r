...
import com.android.mod.CameraPreference;
...
public class IndicatorControlWheelContainer extends IndicatorControlContainer {
    ...
    protected void onFinishInflate() {
        ...
        mShutterButtonRadius = com.android.mod.Util.dpToPixel(SHUTTER_BUTTON_RADIUS);
    ...
    public void onIndicatorEvent(int event) {
        switch (event) {
            case OnIndicatorEventListener.EVENT_ENTER_ZOOM_CONTROL:
                mIndicatorControlWheel.setVisibility(GONE);
                mZoomControlWheel.setVisibility(VISIBLE);
                mZoomControlWheel.startZoomControl();
                break;

            case OnIndicatorEventListener.EVENT_LEAVE_ZOOM_CONTROL:
                mZoomControlWheel.setVisibility(GONE);
                mIndicatorControlWheel.setVisibility(VISIBLE);
                break;
        }
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        if (radius <= mShutterButtonRadius) {
            if (mIndicatorControlWheel.getVisibility() == VISIBLE) {
    ...
    protected void onLayout(
        ...
        mCenterX = right - left - com.android.mod.Util.dpToPixel(FULL_WHEEL_RADIUS);
