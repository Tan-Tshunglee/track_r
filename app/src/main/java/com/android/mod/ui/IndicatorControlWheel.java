...
public class IndicatorControlWheel extends IndicatorControl implements
    ...
    public void initialize(Context context, PreferenceGroup group,
        ...
        mStrokeWidth = com.android.mod.Util.dpToPixel(IndicatorControlWheelContainer.STROKE_WIDTH);
        ...
        // Add Zoom Icon.
        if (isZoomSupported) {
            mZoomIcon = (ImageView) addImageButton(context, R.drawable.ic_zoom_in_holo_light, false);
        }
    ...
    protected void onLayout(
        ...
        mCenterX = right - left - com.android.mod.Util.dpToPixel(
    ...
    public void setEnabled(boolean enabled) {
        ...
        if (mCurrentMode == MODE_VIDEO) {
            mSecondLevelIcon.setVisibility(enabled ? VISIBLE : INVISIBLE);
            mCloseIcon.setVisibility(enabled ? VISIBLE : INVISIBLE);
            requestLayout();
        } else {
