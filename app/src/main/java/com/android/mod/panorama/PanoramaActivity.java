...
package com.android.mod.panorama;
...
import com.android.mod.ActivityBase;
import com.android.mod.CameraDisabledException;
import com.android.mod.CameraHardwareException;
import com.android.mod.CameraHolder;
import com.android.mod.Exif;
import com.android.mod.MenuHelper;
import com.android.mod.ModePicker;
import com.android.mod.OnClickAttr;
import com.android.mod.ShutterButton;
import com.android.mod.SoundPlayer;
import com.android.mod.Storage;
import com.android.mod.SystemProperties;
import com.android.mod.Thumbnail;
import com.android.mod.ui.RotateImageView;
import com.android.mod.ui.SharePopup;
...
public class PanoramaActivity extends ActivityBase implements
    ...
    private class PanoOrientationEventListener extends OrientationEventListener {
        ...
        public void onOrientationChanged(int orientation) {
            ...
            mDeviceOrientation = com.android.mod.Util.roundOrientation(orientation, mDeviceOrientation);
            // When the screen is unlocked, display rotation may change. Always
            // calculate the up-to-date orientationCompensation.
            int orientationCompensation = mDeviceOrientation
                    + com.android.mod.Util.getDisplayRotation(PanoramaActivity.this);
    ...
    public void onCreate(Bundle icicle) {
        ...
        com.android.mod.Util.enterLightsOutMode(window);
        com.android.mod.Util.initializeScreenBrightness(window, getContentResolver());
    ...
    private void openCamera() {
        try {
            mCameraDevice = com.android.mod.Util.openCamera(this, CameraHolder.instance().getBackCameraId());
        } catch (CameraHardwareException e) {
            com.android.mod.Util.showErrorAndFinish(this, R.string.cannot_connect_camera);
            return;
        } catch (CameraDisabledException e) {
            com.android.mod.Util.showErrorAndFinish(this, R.string.camera_disabled);
            return;
        }
    }
    ...
    private void updateThumbnailButton() {
        ...
        if ((mThumbnail == null || !com.android.mod.Util.isUriValid(mThumbnail.getUri(), contentResolver))) {
    ...
    private void startCameraPreview() {
        ...
        int orientation = com.android.mod.Util.getDisplayOrientation(com.android.mod.Util.getDisplayRotation(this),
